 ...
 *     @fileOverview This script use Arrow function JS
...
const iterateUsers = [
    {"user_id":1,"first_name":"Peadar","last_name":"Popeley","age":24,"email":"ppopeley0@usnews.com","country":"China","favorite_color":"green","gender":"Male","shirt_size":"2XL"},
    ...
    //Iteration with forEach and display in console
    iterateUsers.forEach(iterateUsers =>{
        console.log('Codigo: ' + iterateUsers.user_id + ' Nombre: ' + iterateUsers.first_name + ' Apellido: ' + iterateUsers.last_name + ' Edad ' + iterateUsers.age + ' Correo: ' + iterateUsers.email + ' Pais: ' + iterateUsers.country + ' Codigo Postal: ' + iterateUsers.postal_code + ' Color favorito: ' + iterateUsers.favorite_color + ' Genero: ' + iterateUsers.gender + ' Talla: ' + iterateUsers.shirt_size)
    });
